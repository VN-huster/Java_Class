...
public class Order {
    ...
    public ArrayList<Digital> itemsOrder = new ArrayList<Digital>(Max_Order);
    ...
    public Digital getLuckyItem(){
        int a = (int) Math.random()*itemsOrder.size();
        Digital temp = itemsOrder.get(a);
        System.out.println("Your lucky disc is "+ temp.getTitle());
        removeDigitalDisk(itemsOrder.get(a));
        return temp;
    }
